...
export const onboardingSteps: readonly OnboardingStep[] = [
  {
    ...
    screen: 'today',
    actionId: 'view-today',
    actionHint: 'Read this first. Today is home.',
    primaryLabel: 'I see Today',
  },
  {
    id: 'build-nav',
    title: 'Build',
  ...
  },
  {
    ...
    actionHint: 'Click an item.',
  },
  {
    id: 'field-meaning',
    title: 'Columns',
    body: 'Columns tell Sundesk how to treat information, so a date can land in Today, a connection can tie work together, and tags can help you find the weird little things later.',
    targetId: 'build-add-field',
    requiredAction: 'targetClick',
    screen: 'build',
    actionId: 'open-field-controls',
    actionHint: 'Click Add column.',
  },
  {
    id: 'field-types',
    ...
    body: [
      ...
      'Tags: Multiple labels on one item, so a task can be Waiting, COI, Steph, and Friday all at once.',
      'Connection: A tie to another area, like a task connected to a community, person, meeting, or document.',
      'Lookup: Information pulled from connected work so she does not retype it.',
      'Rollup: A calculated summary from connected work, like count, total, earliest date, latest date, or open items.',
    ].join('\n'),
  ...
  },
  {
    id: 'linked-records',
    title: 'Connections',
    body: 'Connections are how one item points to another, so a task can belong to a community and still show up in the places that need it.',
    targetId: 'linked-record-cell',
    requiredAction: 'targetClick',
    screen: 'build',
    actionId: 'inspect-linked-records',
    actionHint: 'Click a connection cell or picker.',
  },
  {
    id: 'views',
    title: 'Saved scans',
    body: 'Saved scans are different ways to look at the same area, so you can filter, sort, group, colour, save, and pin the angle that helps.',
    targetId: 'build-view-controls',
    requiredAction: 'targetClick',
    screen: 'build',
    actionId: 'open-view-controls',
    actionHint: 'Click the scan controls.',
  },
  {
    id: 'meetings',
    title: 'Meetings',
    body: 'Meetings pull the work, waiting items, risks, and connected items into one prep surface.',
